...
public class MainActivity extends AppCompatActivity implements TaskAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call retrieveTasks from here and remove the onResume method
        setupViewModel();
    }

    //This method is not retrieving the tasks any more. Refactor to a more suitable name such as setupViewModel
    private void setupViewModel() {
        //Remove the logging and the call to loadAllTasks, this is done in the ViewModel now
